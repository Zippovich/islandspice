    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
	  ...
	  $fieldset->addField('file', 'image', array(
	  	...
	  	/*$fieldset->addField('on_home', 'checkbox', array(
            'name'      => 'on_home',
		...
		$shortContentField = $fieldset->addField('short_content', 'editor', array(
            'name'      => 'short_content',
            'style'     => 'height:20em; width:50em;',
            'required'  => false,
            'disabled'  => $isElementDisabled,
        ...
        $renderer = $this->getLayout()->createBlock('adminhtml/widget_form_renderer_fieldset_element')
                    ->setTemplate('cms/page/edit/form/renderer/content.phtml');
        $shortContentField->setRenderer($renderer);
        ...
        $fieldset->addField('is_active', 'select', array(
            ...
            'name'      => 'is_active',
            'required'  => true,
            'options'   => array('Disallowed', 'Allowed'),
            'disabled'  => $isElementDisabled,
        ));
        if (!$model->getId()) {
            $model->setData('is_active', $isElementDisabled ? '0' : '1');
